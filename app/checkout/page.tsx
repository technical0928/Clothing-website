...
const CheckoutPage = () => {
  ...
  // doesn't bounce the user to /cart before the confirmation redirect.
  ...
  const makePurchase = async () => {
    ...
    if (checkoutItems.length === 0) {
      toast.error(buyNowItem ? "Something went wrong" : "Your cart is empty");
      return;
    }
  ...
  useEffect(() => {
    if (checkoutItems.length === 0 && !orderPlacedRef.current) {
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
                  ...
                  <div className="flex-auto space-y-1">
                    ...
                    {(product?.selectedSize || product?.selectedColor) && (
                      <p className="text-xs text-stone-600">
                        {product?.selectedSize && <span className="mr-2">Size: {product.selectedSize}</span>}
            ...
            <dl className="hidden space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-gray-900 lg:block">
              <div className="flex items-center justify-between">
                ...
                <dd>PKR {checkoutTotal.toLocaleString()}</dd>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <dd>PKR {Math.round(checkoutTotal * 0.05).toLocaleString()}</dd>
              </div>
              <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                <dt className="text-base">Total</dt>
                <dd className="text-base">
                  PKR {checkoutTotal === 0 ? 0 : Math.round(checkoutTotal + checkoutTotal * 0.05).toLocaleString()}
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="ml-3">
                        ...
                        <p className="mt-0.5 text-sm text-gray-500">{method.desc}</p>
                      </div>
                    </label>
                  ))}
                </div>
            ...
            <div className="mt-10 border-t border-gray-200 pt-6 ml-0">
              <button
                ...
                disabled={isSubmitting}
                className="w-full rounded-md border border-transparent bg-stone-900 px-20 py-2 text-lg font-medium text-white shadow-sm hover:bg-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-600 focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
