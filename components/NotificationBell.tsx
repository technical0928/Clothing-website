  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-1"
        ...
        <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
          ...
          <div className="p-3 bg-gray-50 border-t border-gray-200">
            <Link
              href="/notifications"
              onClick={() => setIsDropdownOpen(false)}
              className="block w-full text-center text-sm text-gray-600 hover:text-amber-700 transition-colors"
            >
