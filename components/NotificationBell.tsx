  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-stone-700 hover:text-amber-600 hover:bg-amber-50 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-1 dark:text-stone-300 dark:hover:text-amber-400 dark:hover:bg-stone-700"
