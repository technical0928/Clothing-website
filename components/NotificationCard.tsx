...
const getPriorityBadge = (priority: NotificationPriority) => {
  const priorityStyles = {
    ...
    [NotificationPriority.NORMAL]: 'bg-amber-100 text-amber-700 border-amber-300',
...
const NotificationCard: React.FC<NotificationCardProps> = ({
  ...
  return (
    <div className={`
      ...
      ${notification.isRead ? 'bg-white border-gray-200' : 'bg-amber-50 border-amber-200 shadow-sm'}
      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex items-center pt-1">
          <input
            ...
            className="w-4 h-4 text-amber-700 bg-gray-100 border-gray-300 rounded focus:ring-amber-500 focus:ring-2"
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center space-x-2 flex-1">
              ...
              {!notification.isRead && (
                <div className="w-2 h-2 bg-amber-600 rounded-full flex-shrink-0" aria-label="Unread notification" />
              )}
            </div>
            ...
            <div className="flex items-center space-x-2">
              {!notification.isRead && (
                <button
                  ...
                  className="inline-flex items-center px-2 py-1 text-xs font-medium text-amber-700 bg-amber-100 rounded hover:bg-amber-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-1 transition-colors"
