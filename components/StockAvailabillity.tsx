...
const StockAvailabillity = ({ stock, inStock } : { stock: number, inStock: number }) => {
  return (
    ...
    { inStock > 0 ? <span className='text-success flex items-center gap-x-1'>In stock <FaCheck /></span> :  <span className='text-error flex items-center gap-x-1'>Out of stock <FaXmark /></span>}
