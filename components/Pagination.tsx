...
const Pagination = () => {
  ...
  return (
    <div className="join flex justify-center py-16">
      <button
        className="join-item btn btn-lg bg-amber-500 text-stone-900 hover:bg-white hover:text-amber-500"
        onClick={() => decrementPage()}
      >
        «
      </button>
      <button className="join-item btn btn-lg bg-amber-500 text-stone-900 hover:bg-white hover:text-amber-500">
        Page {page}
      </button>
      <button
        className="join-item btn btn-lg bg-amber-500 text-stone-900 hover:bg-white hover:text-amber-500"
