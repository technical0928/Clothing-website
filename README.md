<h1>Noor-e-Multan Clothing Store With Admin Dashboard in Next.js and Node.js</h1>

<p><b>Noor-e-Multan is a premium Pakistani clothing brand</b> offering warm ready-to-wear, lawn collections, and elegant formalwear with delivery across Pakistan. This repository showcases a full-stack Next.js and Node.js shopping experience with customer storefront, checkout, and admin dashboard capabilities.
Noor-e-Multan brings cultural style to modern wardrobes through curated seasonal fashion, thoughtful product details, and an easy merchant/admin workflow. The application is built with responsive design and a tailored fashion brand identity.</p>
...
<h2>Noor-e-Multan – Key features</h2>
<p>Noor-e-Multan is a premium apparel storefront built with Next.js and Node.js. The site includes a full-featured admin dashboard, responsive shopping experience, and tailored inventory workflows for clothing and accessories. The template is designed for a warm, elegant fashion brand identity with gold and cream accents.</p>
<h3>Is Next.js good for fashion eCommerce?</h3>
<p>Next.js is an excellent choice for fashion eCommerce because it offers fast page loads, strong SEO, and rich server-side rendering. This setup helps premium apparel brands deliver polished product catalogs, smooth checkout flows, and scalable performance.</p>
...
DATABASE_URL="mysql://username:password@localhost:3306/noor-e-multan?sslmode=disabled"
...
![Noor-e-Multan home page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Home+Page)

<h3>Shop page</h3>

![Noor-e-Multan shop page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Shop+Page)

<h3>Single product page</h3>

![Noor-e-Multan single product page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Single+Product+Page)

<h3>Register page</h3>

![Noor-e-Multan register page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Register+Page)

<h3>Login page</h3>

![Noor-e-Multan login page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Login+Page)

<h3>Search page</h3>

![Noor-e-Multan search page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Search+Page)

<h3>Wishlist page</h3>

![Noor-e-Multan wishlist page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Wishlist+Page)

<h3>Cart page</h3>

![Noor-e-Multan cart page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Cart+Page)

<h3>Checkout page</h3>

![Noor-e-Multan checkout page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Checkout+Page)

<h3>Admin dashboard - All orders page</h3>

![Noor-e-Multan admin orders page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Admin+Orders)

<h3>Admin dashboard - All products page</h3>

![Noor-e-Multan admin products page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Admin+Products)

<h3>Admin dashboard - All categories page</h3>

![Noor-e-Multan admin categories page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Admin+Categories)

<h3>Admin dashboard - All users page</h3>

![Noor-e-Multan admin users page](https://via.placeholder.com/800x400?text=Noor-e-Multan+Admin+Users)
