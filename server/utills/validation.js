...
const validateOrderData = (orderData) => {
  ...
  validatedData.paymentMethod = orderData.paymentMethod
    ...
    : 'cod';
  if (!validPaymentMethods.includes(validatedData.paymentMethod)) {
    errors.push({
      field: 'paymentMethod',
      message: 'Invalid payment method'
    });
  }
  validatedData.paymentStatus = orderData.paymentStatus
    ? String(orderData.paymentStatus).toLowerCase()
    : 'pending';
  if (!validPaymentStatuses.includes(validatedData.paymentStatus)) {
    errors.push({
      field: 'paymentStatus',
